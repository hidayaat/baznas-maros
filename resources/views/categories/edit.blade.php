                    ...
                    <form action="{{ route('categories.update',['category'=> $category]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input id="input_category_thumbnail" name="thumbnail" value="{{ old('thumbnail', asset($category->thumbnail)) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select id="select_category_parent" name="parent_category" data-placeholder="pilih induk kategori"
                                ...
                                @if (old('parent_category', $category->parent))
                                    <option value="{{ old('parent_category', $category->parent)->id }}" selected>{{ old('parent_category', $category->parent)->title }}
                                    </option>
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="input_category_description" name="description"
                                ...
                                placeholder="Masukkan deskripsi disini...">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
